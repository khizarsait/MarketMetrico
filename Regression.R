...
trainIndex <- createDataPartition(marketing_data$Conversion_Rate, p = 0.8, list = FALSE)
...
print(train_subset_data)
# Train regression model
conversion_model <- train(Conversion_Rate ~ ., data = train_subset_data, method = "lm")
